 ...
 * This class is more strict on integer format.
 * @author Group0065
 * @version 1.0.0
 */
public class RoomUserInput implements InputStrategy {
    private Scanner sc;
     ...
     * enter until user enter a valid number or user enter 'r' to leave
     * @return the time input from the user， or null if user leaves "r".
     */
    public Integer inputInteger() {
        ...
        while(numTime < 0) {
            ...
            try {
                ...
                if(numTime < 0 || numTime > 23){
                    presenter.invalidTimeSlots();
                }
     ...
     * ask user to enter again until gets a valid time,or user enter 'r' to exit.
     * @return timestamp gets from user, or null if user entered 'r' to leave
     */
     ...
     * enter a valid input until user enters a valid input or enter 'r' to leave
